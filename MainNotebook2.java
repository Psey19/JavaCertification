...
//   Также ввёл возможность добавления экземпляров одинаковой модели, но поскольку у нас есть полная проверка по хэшу на эквивалентность,
//   то я ввёл новый параметр Серийный номер sn.
...
//   (Ввёл дополнительную проверку на ввод только чисел, как и обещал)
